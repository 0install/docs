...
<dl>
 <dt><a href='http://gfxmonk.net/dist/0install/0downstream.xml'>0downstream</a></dt>
 <dd>
...
number and release date, tagging the release in your version control system and updating your Zero Install feed.
 ...
 <dt><a href='0repo.html'>0repo</a></dt>
 <dd>
   <b>0repo</b> helps you to maintain a repository of 0install software for others to use. It takes a new release
   generated by e.g. 0template and adds it to its collection. Then it generates a set of static files which you can
 ...
 <dt><a href='0template.html'>0template</a></dt>
 <dd>
   <b>0template</b> generates the XML for one version of a program from a template. It is
   a useful replacement for <b>0downstream</b> for more complex programs (e.g. source code
   that must be compiled or programs with dependencies).
 </dd>
...
<b>pkg2zero</b> publishes a Debian or RPM package in a Zero Install feed.
 ...
 <dt><a href='https://github.com/0install/pom2feed'>pom2feed</a></dt>
 <dd>
   The Zero Install Maven Integration connects the world of Zero Install with Apache Maven. With this project Zero Install gets access to the huge number of Java projects available at Maven Central. This is made possible by two components: the pom2feed-service and the pom2feed-maven-plugin.</dd>

 <dt><a href='http://0install.de/docs/publishing/tools/'>Zero Install Publishing tools (.NET)</a></dt>
 <dd>A .NET equivalent of 0publish-GUI (e.g. for Windows).</dd>
</dl>
