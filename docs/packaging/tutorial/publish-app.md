...
!!! tip
    Fix any [feedlint](../../tools/feedlint.md) warnings before continuing &ndash; they catch missing metadata, broken URLs and other issues that would surface later when users try to install your feed.
